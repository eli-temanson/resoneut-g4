...
public:
  ...
  void SetHit(G4int copyNo, G4int trackID, G4double time, G4double energy, G4ThreeVector pos, G4ParticleDefinition* particle, G4String target) {
    ID = copyNo;
    TrackID = trackID;
    Time = time;
    Energy = energy;
  ...
  G4String GetTargetName() const {return TargetName;}
...
private:
  ...
  G4String TargetName; // interaction particle
};

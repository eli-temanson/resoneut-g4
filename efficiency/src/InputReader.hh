...
public:
  ...
  double GetBeamPosX() {return beam_x;}
  double GetBeamPosY() {return beam_y;}
  double GetBeamPosZ() {return beam_z;}
  double GetBeamPx() {return beam_px;}
  double GetBeamPy() {return beam_py;}
  double GetBeamPz() {return beam_pz;}

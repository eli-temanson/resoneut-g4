...
InputReader::InputReader(std::string input_filename) {
  ...
  beam_x = config["beam"][0]["pos"][0].get<double>();
  beam_y = config["beam"][0]["pos"][1].get<double>();
  beam_z = config["beam"][0]["pos"][2].get<double>();

  beam_px = config["beam"][0]["momentum"][0].get<double>();
  beam_py = config["beam"][0]["momentum"][1].get<double>();
  beam_pz = config["beam"][0]["momentum"][2].get<double>();
